...
<div class="adminPanel">
    ...
    <div class="last-time-login">
        <?php if (!empty($lastLoginTime))
            echo "<p>Last Time Successful Login: " . $lastLoginTime . "</p>"; ?>
    </div>
    <div class="greetings">
        <?php
        if ($currentTime > "00:00:00" && $currentTime < "12:00:00") {
            echo "<h3>Good morning, " . $_SESSION['user_name'] . ". Welcome to administration panel.</h3>";
        }
        if ($currentTime > "12:00:00" && $currentTime < "17:00:00") {
            echo "<h3>Good afternoon, " . $_SESSION['user_name'] . ". Welcome to administration panel.</h3>";
        }
        if ($currentTime > "17:00:00" && $currentTime < "20:00:00") {
            echo "<h3>Good evening, " . $_SESSION['user_name'] . ". Welcome to administration panel.</h3>";
        }
        if ($currentTime > "20:00:00" && $currentTime < "24:00:00") {
            echo "<h3>Good night, " . $_SESSION['user_name'] . ". Welcome to administration panel.</h3>";
        }
        ?>
    </div>
